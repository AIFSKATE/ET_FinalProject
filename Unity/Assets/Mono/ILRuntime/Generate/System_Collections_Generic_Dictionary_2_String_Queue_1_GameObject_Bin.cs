...
{
    unsafe class System_Collections_Generic_Dictionary_2_String_Queue_1_GameObject_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.Dictionary<System.String, System.Collections.Generic.Queue<UnityEngine.GameObject>>);
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("ContainsKey", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ContainsKey_0);
            args = new Type[]{typeof(System.String), typeof(System.Collections.Generic.Queue<UnityEngine.GameObject>)};
        ...
        static StackObject* ContainsKey_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.Dictionary<System.String, System.Collections.Generic.Queue<UnityEngine.GameObject>> instance_of_this_method = (System.Collections.Generic.Dictionary<System.String, System.Collections.Generic.Queue<UnityEngine.GameObject>>)typeof(System.Collections.Generic.Dictionary<System.String, System.Collections.Generic.Queue<UnityEngine.GameObject>>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* set_Item_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Collections.Generic.Queue<UnityEngine.GameObject> @value = (System.Collections.Generic.Queue<UnityEngine.GameObject>)typeof(System.Collections.Generic.Queue<UnityEngine.GameObject>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.Dictionary<System.String, System.Collections.Generic.Queue<UnityEngine.GameObject>>();
