...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Graphics_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            method = type.GetMethod("Blit", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Blit_1);
        ...
        static StackObject* Blit_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
