...
{
    unsafe class System_Collections_Generic_Dictionary_2_String_AsyncOperationHandle_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.Dictionary<System.String, UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle>);
            args = new Type[]{};
            ...
            args = new Type[]{typeof(System.String), typeof(UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle)};
        ...
        static StackObject* get_Values_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.Dictionary<System.String, UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle> instance_of_this_method = (System.Collections.Generic.Dictionary<System.String, UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle>)typeof(System.Collections.Generic.Dictionary<System.String, UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* Add_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle @value = (UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle)typeof(UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.Dictionary<System.String, UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle>();
