...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Cinemachine_CinemachineVirtualCameraBase_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(UnityEngine.Transform)};
            method = type.GetMethod("set_LookAt", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_LookAt_1);


        }


        static StackObject* set_Follow_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* set_LookAt_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            instance_of_this_method.LookAt = value;
