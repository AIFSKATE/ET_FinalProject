...
//will auto register in unity
        ...
        public static void Initialize(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            UnlimitedScrollUI_UIBagCell_Binding.Register(app);
            ...
            System_Collections_Generic_Dictionary_2_ICell_ILTypeInstance_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_Int32_Int32_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_Int64_ILTypeInstance_Binding.Register(app);
            UnlimitedScrollUI_GridUnlimitedScroller_Binding.Register(app);
            ...
            System_Single_Array2_Binding.Register(app);
            System_Array_Binding.Register(app);
            System_ArgumentException_Binding.Register(app);
            System_Single_Binding.Register(app);
            UnityEngine_Sprite_Binding.Register(app);
            System_Threading_Tasks_Task_1_Single_Binding.Register(app);
            System_Runtime_CompilerServices_TaskAwaiter_1_Single_Binding.Register(app);
            System_Collections_Generic_List_1_ReferenceCollector_Binding.Register(app);
            System_Collections_Generic_List_1_Boolean_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_ILTypeInstance_RectTransform_Binding.Register(app);
            ...
            System_Collections_Generic_Stack_1_String_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_Int32_Stack_1_String_Binding.Register(app);
            ...
            Cinemachine_CinemachineTransposer_Binding.Register(app);
            Cinemachine_CinemachineComposer_Binding.Register(app);
            ...
            System_Collections_Generic_Dictionary_2_String_AsyncOperationHandle_Binding_ValueCollection_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_String_AsyncOperationHandle_Binding_ValueCollection_Binding_Enumerator_Binding.Register(app);
            ...
            IRecycle_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_String_Queue_1_GameObject_Binding_Enumerator_Binding.Register(app);
            System_Collections_Generic_KeyValuePair_2_String_Queue_1_GameObject_Binding.Register(app);
