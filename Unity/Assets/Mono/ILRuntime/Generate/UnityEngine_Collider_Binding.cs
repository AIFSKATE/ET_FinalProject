...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Collider_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_isTrigger_0);


        }


        static StackObject* get_isTrigger_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
