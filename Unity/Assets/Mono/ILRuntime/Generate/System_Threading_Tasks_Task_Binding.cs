    ...
    unsafe class System_Threading_Tasks_Task_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            if (genericMethods.TryGetValue("Run", out lst))
            {
                ...
                {
                    if(m.MatchGenericParameters(args, typeof(System.Threading.Tasks.Task<System.Single>), typeof(System.Func<System.Single>)))
                    {
        ...
        static StackObject* Run_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Func<System.Single> @function = (System.Func<System.Single>)typeof(System.Func<System.Single>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)8);
            __intp.Free(ptr_of_this_method);


            var result_of_this_method = System.Threading.Tasks.Task.Run<System.Single>(@function);
